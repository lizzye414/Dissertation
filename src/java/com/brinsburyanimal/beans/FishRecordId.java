...
/**
 * FishRecordId generated by hbm2java
 */
public class FishRecordId  implements java.io.Serializable {
    ...
    public FishRecordId(int accommId, Date recordDate, String recordTime) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof FishRecordId) ) return false;
		 FishRecordId castOther = ( FishRecordId ) other; 
